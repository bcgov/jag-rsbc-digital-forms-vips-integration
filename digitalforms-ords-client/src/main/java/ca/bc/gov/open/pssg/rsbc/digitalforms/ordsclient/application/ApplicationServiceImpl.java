...
public class ApplicationServiceImpl implements ApplicationService {
	...
	public ApplicationResponse getApplication(String formGuid) {
		try {
			...
			logger.error(String.format("Application Service Get did throw exception: %s", ex.getMessage()), ex);
	...
	public ApplicationResponse patchApplication(String formGuid, DigitalFormPatchRequest request) {
		try {
			...
			logger.error(String.format("Application Service Patch did throw exception: %s", ex.getMessage()), ex);
			return ApplicationResponse.errorResponse(ex.getMessage());
		}
	}
	...
	public ApplicationResponse postApplication(DigitalFormPostRequest request) {
		try {
			...
			logger.error(String.format("Application Service Post did throw exception: %s", ex.getMessage()), ex);
			return ApplicationResponse.errorResponse(ex.getMessage());
		}
	}
}
