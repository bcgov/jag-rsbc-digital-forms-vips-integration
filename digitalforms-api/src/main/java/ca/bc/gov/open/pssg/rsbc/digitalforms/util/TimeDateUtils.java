...
public class TimeDateUtils {
	...
	public static String DateToICBCDateFormat(Date date) {
		SimpleDateFormat formatter = new SimpleDateFormat(VipswsConstants.ICBC_DATE_FORMAT);
	...
	public static String getDisplayDate(Date date) {
		SimpleDateFormat formatter = new SimpleDateFormat(VipswsConstants.VIPS_DISPLAY_DATE_FORMAT);
		return formatter.format(date);
	}
