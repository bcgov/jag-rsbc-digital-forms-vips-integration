...
import ca.bc.gov.open.pssg.rsbc.digitalforms.model.IRPReviewFormRequest.Field;
 ...
 *
 */
public class IRPReviewFormRequestTests {

	@Test
	public void testObj() {
		IRPReviewFormRequest formRequest = new IRPReviewFormRequest();
