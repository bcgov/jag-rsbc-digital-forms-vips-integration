Feature: POST Application Form Data
  ...
  Scenario Outline: Test the POST endpoint of Application Form Data
    Given the database doesn't have any record for FormType "<formType>" FirstName "<fName>" SecondName "<sName>" LastName "<surname>" CorrelationId "<correlationId>"
    ...
    Examples:
      | formType | noticeNo | correlationId | email          | fax        | fName           | formData     | entry | noticeSubject | phone      | presentationType | rvwRoleType | sName           | surname           |
      | IRP      | 21900103 | POST_IRP      | test1@test.com | 1111111111 | POST_IRP_fName  | formData_IRP | Y     | PERS          | 1111111111 | WRIT             | LWYR        | POST_IRP_sName  | POST_IRP_surname  |
      | ADP      | 00312312 | POST_ADP      | test2@test.com | 2222222222 | POST_ADP_fName  | formData_ADP | Y     | PERS          | 2222222222 | WRIT             | LWYR        | POST_ADP_sName  | POST_ADP_surname  |
      | UL       | 21900503 | POST_UL       | test3@test.com | 3333333333 | POST_UL_fName   | formData_UL  | Y     | PERS          | 3333333333 | WRIT             | LWYR        | POST_UL_sName   | POST_UL_surname   |
