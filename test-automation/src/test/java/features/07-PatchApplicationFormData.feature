Feature: PATCH Application Form Data
  ...
  Scenario Outline: Test the PATCH endpoint of Application Form Data
    ...
    Examples:
      ...
      | IRP      | adf714c8-8aff-65e3-e054-00144ff95450 | PATCH_IRP     | test4@test.com | 4444444444 | PATCH_IRP_fName | formData_IRP | Y     | PERS          | 4444444444 | WRIT             | LWYR        | PATCH_IRP_sName | PATCH_IRP_surname |
      | ADP      | adf714c8-8b00-65e3-e054-00144ff95450 | PATCH_ADP     | test5@test.com | 5555555555 | PATCH_ADP_fName | formData_ADP | Y     | PERS          | 5555555555 | WRIT             | LWYR        | PATCH_ADP_sName | PATCH_ADP_surname |
      | UL       | adf714c8-8b01-65e3-e054-00144ff95450 | PATCH_UL      | test6@test.com | 6666666666 | PATCH_UL_fName  | formData_UL  | Y     | PERS          | 6666666666 | WRIT             | LWYR        | PATCH_UL_sName  | PATCH_UL_surname  |
